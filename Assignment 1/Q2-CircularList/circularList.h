...
If x is NULL, code should still create the list with single node y and return it. */
...
/* OPTIONAL: Count the number of elements in the list and return it */
int getNumElements(node* x);

/* OPTIONAL: Count the number of *distinct* elements and return it */
int getNumDistinctElements(node* x);
